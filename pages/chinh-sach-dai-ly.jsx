  ...
  const reasons = [
    {
      ...
      desc: "Vải nhập khẩu từ nước ngoài, công nghệ UNI DRY độc quyền, kiểm định đạt QCVN 01:2017/BCT — không Formaldehyde, không thuốc nhuộm Azo gây ung thư.",
            ...
            <div className="prose prose-lg max-w-none text-gray-800">
              ...
              <section className="py-2 md:py-10">
                <div className="mb-2">
                  ...
                  <div className="flex flex-col lg:flex-row gap-4 lg:items-end justify-between">
                    ...
                    <p className="text-sm md:text-base text-gray-600 max-w-lg leading-relaxed m-0 pb-1">
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-stretch mt-2">
                  ...
                  <div className="relative rounded-3xl overflow-hidden aspect-square w-full shadow-md group">
                    ...
                    <div className="absolute bottom-2 left-4 right-4 md:bottom-3 md:left-6 md:right-auto md:w-[85%] bg-black/50 backdrop-blur-md border border-white/10 p-3 rounded-2xl text-white transform transition-all duration-500">
                      <p className="text-sm md:text-base leading-relaxed font-medium m-0">
              ...
              <section className="relative bg-white py-2 md:py-10">
                ...
                <div className="grid md:grid-cols-2 gap-8 items-center mb-2">
                  <div className="order-2 md:order-1">
                    ...
                    <Link href="/dang-ky-dai-ly" className="inline-flex items-center justify-center w-10 h-10 rounded-full border border-gray-300 hover:bg-[#105d97] hover:border-[#105d97] transition-colors group">
              ...
              <section className="relative bg-white py-2 md:py-10">
                <div className="text-center container mx-auto mb-10">
                  <h2 className="text-xl md:text-3xl font-bold text-gray-900 leading-tight mb-3">
        ...
        <div className="container mx-auto px-4 relative z-10 py-16 md:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="text-sm md:text-base text-[#D3D3D3] leading-relaxed max-w-2xl mb-6">
