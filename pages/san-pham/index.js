...
const DEFAULT_META = {
  title: "Đồng Phục Univi — Xưởng Sản Xuất Đồng Phục Thể Thao Chuyên Dụng Tại Hà Nội",
  description:
    "Xưởng 2.000m² tại Đan Phượng, công suất 100.000 sp/tháng. Đồng phục Gym, Yoga, Pilates, Pickleball, Áo Gió cho phòng tập & doanh nghiệp B2B. Vải UNI DRY kiểm định QCVN 01:2017/BCT. Tư vấn miễn phí: 0834.204.999",
  keywords:
  ...
  og: {
    title: "Đồng Phục Univi — Xưởng Sản Xuất Đồng Phục Thể Thao Chuyên Dụng Tại Hà Nội",
    description:
      "Xưởng sản xuất đồng phục thể thao chuyên dụng tại Hà Nội — công nghệ UNI DRY, vải nhập khẩu, kiểm định QCVN 01:2017/BCT. Phục vụ phòng tập Gym, Yoga, Pickleball và doanh nghiệp toàn quốc.",
    type: "website",
...
// ─── COLLECTION SCHEMA — định nghĩa tĩnh, không đổi ─────────
...
const COLLECTION_SCHEMA = [
  ...
  },
  {
    ...
    "name": "Đồng Phục Thể Thao Univi — Toàn Bộ Sản Phẩm",
    "description": "Xưởng sản xuất đồng phục thể thao chuyên dụng tại Hà Nội — Gym, Yoga, Pickleball, Áo Gió, Áo Polo. Công nghệ UNI DRY, kiểm định QCVN 01:2017/BCT.",
    "url": "https://dongphucunivi.com/san-pham",
...
const ProductsPage = ({ relatedPosts }) => {
  ...
  return (
    <DefaultLayout2>
      ...
      {/* CollectionPage schema — đặt ngoài component, không tạo lại mỗi render */}
      <script
