            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-6">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  <li><strong>Sở hữu của Univi:</strong> Toàn bộ nội dung trên website dongphucunivi.com, bao gồm nhưng không giới hạn ở văn bản, hình ảnh, video, logo, biểu tượng, thiết kế đồ họa, và các mẫu sản phẩm đã được triển khai, đều là tài sản độc quyền của Công ty TNHH Bảo Phong Evenes.</li>
