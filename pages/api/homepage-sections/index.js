...
const DEFAULT_SECTIONS = [
  { title: "Đồng Phục Gym", category: "dong-phuc-gym", viewAllLink: "/san-pham/dong-phuc-gym", order: 0, isVisible: true, productLimit: 12 },
  { title: "Đồng Phục Pickleball", category: "dong-phuc-pickleball", viewAllLink: "/san-pham/dong-phuc-pickleball", order: 1, isVisible: true, productLimit: 12 },
  { title: "Đồng Phục Yoga - Pilates", category: "dong-phuc-yoga-pilates", viewAllLink: "/san-pham/dong-phuc-yoga-pilates", order: 2, isVisible: true, productLimit: 12 },
  { title: "Đồng Phục Áo Gió", category: "dong-phuc-ao-gio", viewAllLink: "/san-pham/dong-phuc-ao-gio", order: 3, isVisible: true, productLimit: 12 },
  { title: "Đồng Phục Golf - Tennis", category: "dong-phuc-golf-tennis", viewAllLink: "/san-pham/dong-phuc-golf-tennis", order: 4, isVisible: true, productLimit: 12 },
  { title: "Đồng Phục Áo Polo", category: "dong-phuc-ao-polo", viewAllLink: "/san-pham/dong-phuc-ao-polo", order: 5, isVisible: true, productLimit: 12 },
];
...
const updateSection = async (req, res) => {
  try {
    ...
    const updates = {};
    const allowed = ["title", "category", "viewAllLink", "isVisible", "productLimit"];
