...
export default function GiaiPhap2S({ meta }) {
  ...
  return (
    <DefaultLayout2>
      ...
      ═══════════════════════════════════════ */}
      <section className="bg-white pt-[100px] pb-[72px]">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              <p className="text-[0.98rem] text-[#6b7280] leading-[1.75] mb-8 max-w-[460px]">
              ...
              <div className="grid grid-cols-2 gap-3.5 mb-8">
                {[
                  { val: "500+", label: "Mẫu thiết kế" },
                  { val: "15K+", label: "Khách hàng hài lòng" },
                  { val: "48+", label: "Đối tác phòng tập" },
                  { val: "13+", label: "Giải thưởng đạt được" },
                ].map((s, i) => (
                  <div key={i} className="py-[18px] px-5 border border-[#e2e8f0] rounded-[10px] bg-[#fafcff] flex flex-col gap-[3px] transition-shadow duration-200 hover:shadow-[0_4px_16px_rgba(16,93,151,0.09)]">
                    <span className="text-[1.9rem] font-black text-[#1a2636] leading-none tracking-[-0.02em]">{s.val}</span>
                    <span className="text-[0.78rem] font-semibold text-[#105d97] tracking-[0.02em]">{s.label}</span>
                  </div>
                ))}
              </div>
              ...
              <div className="flex items-center gap-[18px] flex-wrap">
                <button
                  onClick={(e) => { e.preventDefault(); if (typeof window !== "undefined") window.dispatchEvent(new Event("openContactModal")); }}
                  className="inline-flex items-center gap-[7px] py-[13px] px-[26px] rounded-[9px] text-[0.92rem] font-bold text-white bg-[#105d97] shadow-[0_4px_18px_rgba(16,93,151,0.3)] transition-all duration-200 hover:bg-[#0b4472] hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(16,93,151,0.38)] cursor-pointer"
                >
            ...
            {/* RIGHT — image on warm circle */}
            <div className="relative  aspect-[4/3] order-first md:order-last animate-fade-in-up" style={{ animationDelay: "0.12s" }}>
              <div className="absolute inset-0 z-10  overflow-hidden">
                <Image
                  src="/images/dong-phuc-pt-gym.jpg"
                  alt="UNIVI SPORTS UNIFORM 2S"
                  fill
                  className=""
                  priority
                />
      ...
      <section id="kham-pha" className="py-8 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 px-4">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-14 items-start">
            ...
            <div className="w-full lg:w-[46%] relative">
              <div className="w-full aspect-[4/3] lg:aspect-[4/3] rounded-[32px] overflow-hidden relative border border-[#e2e8f0]">
            ...
            <div className="w-full lg:flex-1 pl-0 lg:pl-10 pt-2 lg:pt-0">
              ...
              <div className="mb-8 lg:mb-12">
                ...
                <h2 className="text-3xl font-extrabold text-[#1a2636] leading-[1.15] tracking-[-0.03em]">
                ...
                {[
                  ...
                  <div key={idx} className="group flex flex-col sm:flex-row sm:items-center py-2 border-b border-[#e2e8f0] transition-colors hover:bg-white cursor-pointer px-4 -mx-4 rounded-[16px]">
                    ...
                    <div className="flex-1 pr-4">
                      <h4 className="text-[1.1rem] leading-tight font-extrabold text-[#1a2636] mb-1 transition-colors group-hover:text-[#105d97]">{item.title}</h4>
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 max-w-[640px]">
            <div className="flex items-center gap-[10px] text-[0.72rem] font-bold tracking-[0.14em] uppercase text-[#105d97] mb-[14px]">
              <span className="w-[28px] h-[2px] bg-[#105d97] rounded-[2px] shrink-0" />
              Giải pháp toàn diện
            </div>
          ...
          <div className="h-[1px] bg-[#e2e8f0] my-9 mb-12" />

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-11 gap-x-9">
            {[
              {
              ...
              {
                icon: <ShieldCheck size={34} />, title: "An toàn Da liễu",
                desc: "Chứng nhận không Formaldehyde & Azo. Bảo vệ sức khỏe nhân viên và hội viên tuyệt đối."
              },
              {
