          ...
          <div className="">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Chất liệu vải được kiểm định bởi Bộ Công thương, <strong>không chứa Formaldehyde</strong>, không thuốc nhuộm Azo gây hại — an toàn tuyệt đối cho da người tập. Đây cũng là lý do các đối tác lớn như Sun Group, KickFit Sports, Fitcare tin tưởng lựa chọn giải pháp đồng phục của chúng tôi cho chuỗi phòng tập của họ.
                </p>
              </section>
