  ...
  const jobs = [
    {
      ...
      description: "Công ty TNHH Bảo Phong Evenes – thương hiệu Đồng phục UNIVI là một công ty gần 10 năm trong ngành đồng phục. Là đối tác cung cấp đồng phục cho các tập đoàn lớn như tập đoàn Sungroup, tập đoàn Thành Công, Tổng công ty Than Khoáng Sản,...",
      requirements: [
                  ...
                  <div className="space-y-3">
                    {selectedJob.requirements.map((req, index) => (
                      <div key={index} className="flex items-start gap-4 p-4 rounded-xl hover:shadow-md transition-all" style={{ backgroundColor: '#eff6ff' }}>
                        ...
                        <span className="text-gray-800 leading-relaxed pt-1">{req}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    {selectedJob.benefits.map((benefit, index) => (
                      <div key={index} className="flex items-start gap-4 p-4 bg-green-50 rounded-xl hover:shadow-md transition-all">
                        ...
                        <span className="text-gray-800 leading-relaxed pt-1">{benefit}</span>
                      </div>
                    ))}
                  </div>
                </div>
