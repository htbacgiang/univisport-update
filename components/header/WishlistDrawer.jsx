            ...
            <div className="divide-y divide-gray-100">
              {items.map((item, index) => (
                <div key={item.id} className="flex gap-3 py-4">
                  {/* Image */}
                  <Link href={`/san-pham/${item.slug}`} onClick={onClose} className="flex-shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <Link href={`/san-pham/${item.slug}`} onClick={onClose}>
                      <p className="text-sm font-medium text-gray-800 line-clamp-2 hover:text-[#105d97] transition-colors leading-snug">
                        {item.name}
                      </p>
                    </Link>
                    {item.color && (
