        ...
        <div className="min-h-screen bg-gray-50">
            <div className="relative z-10 max-w-7xl mx-auto px-4 py-6">
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg  hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="grid gap-3 mt-4">
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Thoáng khí tối đa & Nhanh khô vượt trội</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Trọng lượng siêu nhẹ</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Giảm ma sát, chống phồng rộp</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Hỗ trợ vận động tự do</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">An toàn hơn trên mọi nẻo đường</h3>
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg  hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 mb-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div>
                                <span className="font-semibold">An toàn tuyệt đối cho người mặc:</span>
                                <span className="text-base ml-2">Tất cả chất liệu vải đều được kiểm định an toàn với da, không chứa hóa chất độc hại như Formaldehyde hay các amin thơm từ thuốc nhuộm Azo.</span>
                            </div>
                            <div>
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg  hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="grid gap-3">
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Nâng cao thành tích và hiệu suất</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Bảo vệ cơ thể toàn diện</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Tự tin chinh phục mọi mục tiêu</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Độ bền cao cho mọi hành trình</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Khẳng định dấu ấn cá nhân và tinh thần đội nhóm</h3>
