        ...
        <div className="min-h-screen bg-gray-50">
            <div className="relative z-10 max-w-7xl mx-auto px-4 py-6">
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="grid gap-1 mt-4">
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Độ bền tối thượng – Chịu đựng mọi thử thách</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Linh hoạt không giới hạn – Tự do trong từng đòn thế</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Kiểm soát độ ẩm và thoáng khí hiệu quả</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Bảo vệ da và giảm thiểu ma sát</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Thể hiện tinh thần chiến binh và sự chuyên nghiệp</h3>
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 mb-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div>
                                <span className="font-semibold">An toàn tuyệt đối cho mỗi chiến binh:</span>
                                <span className="text-base ml-2">Tất cả chất liệu vải được sử dụng đều trải qua quy trình kiểm định nghiêm ngặt về độ an toàn với da, cam kết không chứa các hóa chất độc hại như Formaldehyde hay các amin thơm từ thuốc nhuộm Azo.</span>
                            </div>
                            <div>
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="grid gap-1">
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Tối ưu hóa sức mạnh và kỹ thuật thi đấu</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Bảo vệ cơ thể hiệu quả, giảm thiểu chấn thương</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Duy trì sự tập trung cao độ và tinh thần chiến đấu bền bỉ</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Thể hiện đẳng cấp, sự chuyên nghiệp và tinh thần đồng đội</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Độ bền thách thức thời gian và những buổi tập khắc nghiệt nhất</h3>
