            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 py-6">
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="grid gap-1 mt-4">
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Thoải mái và linh hoạt tối đa</h3>
                            <p>Giúp bạn thực hiện cú swing Golf trọn vẹn hoặc cú giao bóng Tennis dứt khoát mà không bị gò bó.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Thoát ẩm và thoáng khí vượt trội</h3>
                            <p>Giữ cơ thể khô ráo, duy trì sự tập trung và năng lượng trong suốt các trận đấu kéo dài dưới ánh nắng.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Tăng sự tự tin và đẳng cấp</h3>
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="grid gap-1">
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Chất liệu chuyên môn sâu</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Uy tín từ đối tác lớn</h3>
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="grid gap-1">
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Nâng cao hiệu suất thi đấu</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Khẳng định Phong thái và Thương hiệu</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Độ bền và Tiết kiệm chi phí</h3>
                        ...
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">An toàn cho Sức khỏe</h3>
                ...
                <article className="bg-white rounded-2xl p-4 md:p-6 mb-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                    ...
                    <div className="grid gap-1">
                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Tư vấn chuyên sâu</h3>
                            <p>Lắng nghe nhu cầu về kiểu dáng, chất liệu, số lượng và ngân sách.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Thiết kế mẫu miễn phí</h3>
                            <p>Lên mẫu demo dựa trên nhận diện thương hiệu của bạn, chỉnh sửa cho đến khi hài lòng.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Duyệt mẫu & Báo giá</h3>
                            <p>Ký hợp đồng sau khi thống nhất thiết kế và báo giá chi tiết.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Sản xuất theo tiêu chuẩn</h3>
                            <p>Đảm bảo chất lượng nghiêm ngặt tại xưởng may hiện đại.</p>
                        </div>

                        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-3 hover:shadow-md transition-all">
                            <h3 className="font-bold text-base mb-1">Giao hàng và Hậu mãi</h3>
