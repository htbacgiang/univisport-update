  ...
  <div className={`rounded-xl p-6 ${accent ? 'bg-blue-50 border-l-4 border-[#105d97]' : 'bg-gray-50'}`}>
    <div className="flex items-start gap-4">
      ...
      <div className="flex-1">
        <h4 className="font-bold text-lg text-[#105d97] mb-2">{title}</h4>
        {children}
      </div>
    </div>
  </div>
...
export default function AboutUniviPage() {
  return (
    <article className="max-w-none">
      ...
      <section className="py-12 px-4 md:px-12 container mx-auto">
          ...
          {[
            ...
            <div key={card.title} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-bold text-[#105d97]">{card.title}</h3>
              </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
          <h3 className="font-bold text-lg text-[#105d97] text-center mb-6">GIÁ TRỊ CỐT LÕI</h3>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h3 className="font-bold text-lg text-[#105d97] text-center mb-6">HỆ SINH THÁI UNIVI</h3>
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
            {[
              ...
              <div key={name} className="text-center bg-gray-50 rounded-xl p-3 hover:shadow-sm transition-shadow">
                ...
                <p className="font-bold text-gray-900 text-xs mb-1">{name}</p>
                <p className="text-gray-500 text-xs">{desc}</p>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 space-y-5">
          ...
          <div className="bg-blue-50 rounded-xl p-5 border-l-4 border-[#105d97]">
            <p className="text-gray-700 leading-relaxed font-medium">
              Mục tiêu lớn của Univi là duy trì quan hệ tốt với <span className="font-bold text-[#105d97]">hàng trăm nghìn khách hàng</span> và đối tác trên cả nước. Chiến lược 2025-2028 nhấn mạnh việc trở thành lựa chọn hàng đầu trong mảng Đồng Phục Thể Thao và xây dựng thương hiệu mạnh mẽ trong ngành sản xuất thời trang tại Việt Nam.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={c.title} className="bg-white rounded-xl p-5 border border-gray-100">
                <h4 className="font-bold text-[#105d97] mb-2">{c.title}</h4>
                <p className="text-gray-700 leading-relaxed">{c.body}</p>
              </div>
            ))}
          </div>
          <div className="bg-blue-50 rounded-xl p-5 border-l-4 border-[#105d97]">
            <h4 className="font-bold text-[#105d97] mb-2">Quy trình sản xuất khép kín</h4>
            <p className="text-gray-700 leading-relaxed">
          ...
          {[
            ...
            <div key={n} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              <div className="flex items-center gap-3 bg-[#105d97]/5 border-b border-gray-100 px-5 py-4">
                ...
                <h4 className="font-bold text-[#105d97] text-sm">{title}</h4>
              </div>
              <div className="p-5">
      ...
      {[
        {
          ...
          body1: <p className="text-lg text-gray-700 leading-relaxed">Univi hiện đang tập trung cung cấp giải pháp <strong className="text-[#105d97]">Đồng Phục Thể Thao</strong>, đặc biệt tập trung vào thị trường Việt Nam với đối tượng chủ yếu là người tập thể thao, đội nhóm tập thể thao.</p>,
          body2: <p className="text-gray-700 leading-relaxed font-medium">Đồng phục Univi không ngừng cố gắng nghiên cứu để mang đến sản phẩm mang <strong className="text-[#105d97]">chất lượng Quốc tế</strong> nhưng giá lại <strong className="text-[#105d97]">phù hợp với người dùng Việt Nam</strong>.</p>,
        ...
        },
        {
          ...
          body1: <p className="text-lg text-gray-700 leading-relaxed">Với xuất phát điểm là đơn vị sản xuất <strong className="text-[#105d97]">Đồng phục doanh nghiệp</strong>, Univi hiểu rằng thị trường đồng phục cho hội nhóm, cơ quan, tổ chức, và doanh nghiệp, nhu cầu chuyên nghiệp hóa ngày càng được ưu tiên.</p>,
          body2: <p className="text-gray-700 leading-relaxed font-medium">Univi, với phương châm luôn phát triển và đổi mới, hướng đến việc mở rộng thị phần <Link href="/dong-phuc-cong-ty" legacyBehavior><a className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">đồng phục doanh nghiệp</a></Link>. Công ty cung cấp đa dạng sản phẩm từ <strong className="text-[#105d97]">trung cấp đến cận cao cấp</strong>.</p>,
          imgs: [
        ...
        },
        {
          ...
          body1: <p className="text-lg text-gray-700 leading-relaxed">Đồng phục khác của <strong className="text-[#105d97]">UNIVI</strong> bao gồm các sản phẩm đa dạng như đồng phục sự kiện, đồng phục teambuilding, áo lớp, áo nhóm và các loại trang phục đặc thù theo yêu cầu. Với sự linh hoạt trong thiết kế và chất liệu cao cấp như <strong className="text-[#105d97]">Cotton, Polyester, hay Piquecool</strong>.</p>,
          body2: <p className="text-gray-700 leading-relaxed font-medium">Tất cả sản phẩm đều được sản xuất theo <strong className="text-[#105d97]">quy trình khép kín</strong>, đảm bảo chất lượng đồng nhất và an toàn cho người mặc.</p>,
        ...
        <section key={n} className="py-6 px-4 md:px-12 container mx-auto">
          <h3 className="text-xl font-bold text-[#105d97] mb-6">{title}</h3>
      ...
      <section className="py-6 px-4 md:px-12 container mx-auto">
        ...
        <div className="space-y-4">
          <StepCard number="3" title="An toàn với sức khỏe người mặc">
            <p className="text-gray-700 leading-relaxed">Tất cả chất liệu vải mà Univi sử dụng đều được kiểm định an toàn với da.</p>
          </StepCard>

          <figure className="max-w-4xl mx-auto">
            <div className="overflow-hidden rounded-xl shadow-sm">
              <Image src="/images/gioi-thieu/chat-luong-san-pham-2.jpg" alt="Chất liệu vải an toàn với sức khỏe từ Univi"
