        ...
        <article className="bg-white p-4 md:p-6 mb-6 border">
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-3">
              ...
              <div className="bg-gray-50 p-4 border">
                <h3 className="font-bold text-base mb-2">3. An toàn đã được Kiểm định</h3>
                <p className="text-base">
                  Cam kết tất cả sản phẩm đều được kiểm định nghiêm ngặt, không chứa <span className="font-semibold">Formaldehyde</span> và <span className="font-semibold">Amin thơm Azo</span>.
                </p>
              </div>
            </div>
        ...
        <article className="bg-white p-4 md:p-6 mb-6 border">
          ...
          <div className="mb-6">
            ...
            <div className="grid gap-2">
              ...
              <div className="p-3 bg-gray-50 border">
                <div>
                  <span className="font-semibold">Không Chất độc hại:</span>
                  <span className="ml-2">Đồng phục Univi cam kết không chứa formaldehyde hay amin thơm chuyển hóa từ thuốc nhuộm Azo – hai chất có khả năng gây ung thư da và ảnh hưởng nghiêm trọng đến sức khỏe con người.</span>
                </div>
              </div>
              <div className="p-3 bg-gray-50 border">
                <div>
          ...
          <div className="my-6 text-center">
            <figure className="inline-block border">
              <Image
                ...
                alt="Đồng phục thể thao Univi kiểm định an toàn không chứa Formaldehyde và Azo"
                width={800}
                height={400}
                layout="responsive"
            ...
            <div className="grid gap-2">
              ...
              <div className="p-3 bg-white border">
                <div>
                  ...
                  <span className="ml-2">Dù là <Link href="/san-pham/dong-phuc-gym" className="text-blue-600 hover:underline">Đồng phục Gym</Link>, <Link href="/san-pham/dong-phuc-pickleball" className="text-blue-600 hover:underline">Pickleball</Link>, <Link href="/san-pham/dong-phuc-yoga-pilates" className="text-blue-600 hover:underline">Yoga</Link>, <Link href="/san-pham/dong-phuc-chay-bo" className="text-blue-600 hover:underline">Chạy bộ</Link>, <Link href="/san-pham/dong-phuc-pickleball" className="text-blue-600 hover:underline">Pickleball</Link>, hay là
                    <Link href="/san-pham/dong-phuc-team-building" className="text-blue-600 hover:underline">Đồng phục Team building</Link> Univi luôn sẵn sàng lắng nghe mong muốn của bạn.</span>
                </div>
              </div>
            </div>
          </div>
