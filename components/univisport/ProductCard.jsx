    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <Link href={`/san-pham/${slug}`} legacyBehavior>
            <a>
              <h3 className="text-[15px] md:text-base font-normal text-gray-800 line-clamp-2 mb-2 md:mb-2 hover:text-blue-600 transition-colors cursor-pointer leading-snug">
                {name}
              </h3>
            </a>
          </Link>
            ...
            {allImages.length > 0 && allImages.slice(0, 5).map((color, index) => {
              ...
              return (
                <button
                  ...
                  className={`w-[28px] h-[28px] md:w-[26px] md:h-[26px] rounded-full p-[2px] transition-all duration-300 border overflow-hidden ${selectedColorIdx === index
                    ? 'border-[#f2b94c]'
