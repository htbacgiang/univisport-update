    ...
    <section className="">
      <div className="container mx-auto mt-10">
        ...
        <div className="text-center mb-12">
          <h3 className="md:text-2xl text-xl font-bold text-[#105d97] uppercase mb-4">
          ...
          >
            {menuItems.map((item, index) => (
              ...
              >
                ...
                <div className="ml-6">
                  <h3 className={`text-lg md:text-xl font-bold mb-3 transition-colors duration-300 ${activeItem === item.title ? 'text-gray-900' : 'text-gray-700'
                    }`} style={{
